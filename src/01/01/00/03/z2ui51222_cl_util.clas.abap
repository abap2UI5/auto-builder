CLASS z2ui51222_cl_util DEFINITION
  PUBLIC
  INHERITING FROM z2ui51222_cl_abap_api
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS rtti_get_t_ddic_fixed_values
      ...
      RETURNING
        VALUE(result) TYPE z2ui51222_cl_abap_api=>ty_t_fix_val ##NEEDED.
...
CLASS z2ui51222_cl_util IMPLEMENTATION.
  ...
  METHOD filter_update_tokens.
    ...
    DATA(lt_range) = z2ui51222_cl_util=>filter_get_range_t_by_token_t( result[ name = name ]-t_token ).
  ...
  METHOD json_parse.
    TRY.
        ...
        z2ui51222_cl_ajson=>parse( val )->to_abap( EXPORTING iv_corresponding = abap_true
  ...
  METHOD json_stringify.
    TRY.
        ...
        DATA(li_ajson) = CAST z2ui51222_if_ajson( z2ui51222_cl_ajson=>create_empty( ) ).
...
*                      v = c_trim_lower( lv_value ) ) INTO TABLE rt_params.
  ...
  METHOD xml_srtti_stringify.
    ...
    ELSE.
      ...
      TRY.
          CALL METHOD z2ui51222_cl_srt_typedescr=>('CREATE_BY_DATA_OBJECT')
        EXPORTING
          data_object = data
        RECEIVING
          srtti       = srtti.
