CLASS z2ui51221_cl_core_srv_util DEFINITION
  PUBLIC
  INHERITING FROM z2ui51221_cl_util
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS app_get_url_source_code
      IMPORTING
        !client       TYPE REF TO z2ui51221_if_client
      RETURNING
...
CLASS z2ui51221_cl_core_srv_util IMPLEMENTATION.
  METHOD app_get_url.
